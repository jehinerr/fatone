...
var require = {
	app: {
		analytics: true,
		copyright: "2015 by fatone",
		deployType: "development",
		description: "undefined",
		guid: "d119a9a7-94d2-4ff5-9444-7bf2e14c32f4",
		id: "com.user_authentication",
		name: "userAuthentication",
		names: {},
		publisher: "fatone",
		url: "http://user_authenticacion.com",
		version: "1.0"
	},
	has: {
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","5606ac1d1a0839ef083c09ff");
	...
	p.setString("acs-oauth-secret-development","UWBHIEKOIyiUtj2xuA6PDvRwG3Qpej4s");
	p.setString("acs-oauth-key-development","uhdUt0TMM0bp78TIbODoOPgQT7CWTKSP");
	p.setString("acs-api-key-development","BMK7Jzj2fiIE81DADrkRIuVGERvLgFuY");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","iOZyGcDZzKA0myeISN");
	...
	p.setString("acs-oauth-secret-production","AaWxfeM4LeyUfAT7mXNb6UaHcgAzGuWq");
	p.setString("acs-oauth-key-production","eSfLthNAFidhzWj8cs1unqMBZeF0vNpA");
	p.setString("acs-api-key-production","ZojyfIw8kycdahTHKVYpWjSDqsy5r8JK");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","DSglq2vYWnFG3mJK4w");
	p.setString("appc-org-id","100055687");
	p.setString("appc-creator-user-id","277d1059-e578-4b1c-96ca-2e493bcd661d");
});
